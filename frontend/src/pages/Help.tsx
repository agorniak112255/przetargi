    ...
    >
      ...
      <Steps
        items={[
          ...
          'Pozycje: przy każdym wierszu wybierany jest produkt główny z bazy. Wyszukaj frazę (SIWZ / produkt), popraw ręcznie albo uruchom „Dopasuj AI (puste)” / „Dopasuj AI (wszystkie)” — przy filtrze AI rusza tylko widoczne wiersze.',
