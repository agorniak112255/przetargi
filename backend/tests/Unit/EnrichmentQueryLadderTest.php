...
final class EnrichmentQueryLadderTest extends TestCase
{
    ...
    public function test_catalog_keeps_secura_valve_flap_despite_glove_category(): void
    {
        $product = new Product([
            'manufacturer' => 'SECURA',
            'sku' => 'S56212-10',
        ...
        $confirmed = $confirm->invoke($service, [
            [
                'url' => $url,
                'title' => 'Płatek zaworu wydechowego SECURA 3000 do półmasek',
                'snippet' => 'secura platek zaworu wydechowego',
            ],
            [
                'url' => 'https://centralabhp.pl/pl/p/Rekawice-elektroizolacyjne-ELSEC-10-kV-SECURA/2820',
                'title' => 'Rękawice elektroizolacyjne ELSEC 10 kV SECURA',
                'snippet' => 'SECURA',
            ],
        ], $product);

        $this->assertSame([$url], array_column($confirmed, 'url'));
    }
    ...
    public function test_catalog_keeps_sir_waders_official_card(): void
    {
        ...
        $confirmed = $confirm->invoke($service, [
            [
                'url' => 'https://www.sirsafety.com/safety-pu-waders',
                'title' => 'SAFETY PU waders | Sir Safety System',
                'snippet' => 'MB2520 S0',
            ],
            [
                'url' => 'https://example.com/mb2520-random-gadget',
                'title' => 'MB2520 gadget',
                'snippet' => '',
            ],
        ], $product);
    ...
    public function test_canis_card_without_sku_in_url_is_still_the_product(): void
    {
        $product = new Product([
            'manufacturer' => 'CANIS SAFETY',
            'sku' => '420000600000',
        ...
        $body = 'Folia ochronna do przyłbicy spawalniczej. Kod: 4200-006-000-00 EAN: 420000600000 CANIS.';
